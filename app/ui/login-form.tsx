          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <AtSymbolIcon className="pointer-events-none absolute left-3 top-1/2 size-[18px] -translate-y-1/2 text-gray-500 transition-colors peer-focus:text-gray-900" />
            </div>
          </div>
          <div className="mt-4">
            <label
            ...
            <div className="relative">
              <input
                ...
                minLength={6}
              />
              <KeyIcon className="pointer-events-none absolute left-3 top-1/2 size-[18px] -translate-y-1/2 text-gray-500 transition-colors peer-focus:text-gray-900" />
            </div>
          </div>
        </div>
